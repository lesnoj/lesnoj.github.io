L.Control.Opacity=L.Control.extend({
	...
	_initLayout:function(){
		...
		if( e.setAttribute("aria-haspopup",!0), L.DomEvent.disableClickPropagation(e), L.DomEvent.disableScrollPropagation(e), this.options.label ){
		    ...
		    l.href="#",
			l.innerHTML = '<img class="icon1" src="opacity/transp.png" />'; //иконка на кнопке управления прозрачностью (параметры в filelayer/style.css)
		    l.title="Layers",
		    L.Browser.touch?( L.DomEvent.on(l, "click", L.DomEvent.stop), L.DomEvent.on(l, "click", this.expand, this)):L.DomEvent.on(l, "focus", this.expand,this),
			i||this.expand(),
	...
	_update:function(){
		if(!this._container)
			...
			var t, e, i, a, s = 0;
			for(i = 0; i < 2; i++)  // показываю в котроле только два первых слоя 
	//		for(i = 0; i < this._layers.length; i++)  //оригинальная запись
				a = this._layers[i],
			    this._addItem(a),
				e = e||a.overlay,
				t = t||!a.overlay,
	...
	_addItem:function(t){
		...
		t.overlay?(e = document.createElement("input"), e.type = "range", e.className = "leaflet-control-layers-range", e.min = 0, e.max = 100, e.value = 100) : e = this._createRadioElement("leaflet-base-layers", checked),
		...
		i.appendChild(s), s.appendChild(a), i.appendChild(l), l.appendChild(e);
	...
	_onInputClick:function(){
		...
		for(var a = i.length-1; a >= 0; a--)
			...
			"undefined"==typeof e._url||e.setOpacity(t.value/100);
