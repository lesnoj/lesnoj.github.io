...
*/
             ...
             * @default
             */
            measureControlLabel: '<img src = "rul/trans.png">',
             /**
...
*/
        ...
        onAdd: function(map) {
	        ...
	        var label = '<a download="mytrack.json"/><img style="pointer-events: none;" class="icon" src="track/search.svg"/></a>'
...
var tmp=this._layerPaint._layers  //mytrack.gpx //must be named mytrack!
  	  for (var layer in tmp) {if (tmp[layer].gpx1) {

console.dir(tmp[layer].gpx1);


tmp=tmp[layer].gpx1; break}}
