L.Control.SlideMenu = L.Control.extend({
    ...
    onAdd: function(map){
        ...
        link.title = 'Условные обозначения';
		
		link.innerHTML = "<img class='icon' src='pan/q.svg'/>"; // добавил свою картинку, class из filelayer/style.css
        ...
        if(this._isHorizontal){
            if(this._isLeftPosition){
				...
				closeButton.innerHTML = "<img class='icon2' src='pan/ar.svg'/>"; // добавил свою картинку, class из filelayer/style.css				
